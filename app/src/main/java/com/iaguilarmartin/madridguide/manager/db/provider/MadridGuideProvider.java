package com.iaguilarmartin.madridguide.manager.db.provider;
...
public class MadridGuideProvider extends ContentProvider {
    public static final String MADRIDGUIDE_PROVIDER = "com.iaguilarmartin.madridguide.provider";
    ...
    static {
        ...
        // content://com.iaguilarmartin.madridguide.provider/shops
        uriMatcher.addURI(MADRIDGUIDE_PROVIDER, "shops", ALL_SHOPS);
        // content://com.iaguilarmartin.madridguide.provider/shops/363
    ...
    public String getType(Uri uri) {
        ...
        switch (uriMatcher.match(uri)) {
            case SINGLE_SHOP :
                type = "vnd.android.cursor.item/vnd.com.iaguilarmartin.madridguide.provider";
                break;
            case ALL_SHOPS:
                type = "vnd.android.cursor.dir/vnd.com.iaguilarmartin.madridguide.provider";
                break;
            default:
                break;
        }
    ...
    public Uri insert(Uri uri, ContentValues contentValues) {
        ...
        // content://com.iaguilarmartin.madridguide.provider/shops/5353
    ...
    public int delete(Uri uri, String where, String[] whereSelection) {
        // content://com.iaguilarmartin.madridguide.provider/shops/72
        // content://com.iaguilarmartin.madridguide.provider/activity/57
